...
// 创建正确的Markdown内容
const correctMarkdown = `# 欢迎使用 BlackNote!
...
// 写入正确的Markdown文件
const filePath = path.join(__dirname, '../../notes-md/Test/开始使用.md');
fs.writeFileSync(filePath, correctMarkdown, 'utf8');
console.log("已创建正确的Markdown文件: " + filePath);